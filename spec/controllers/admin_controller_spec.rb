  ...
  context "admin user" do
    ...
    describe "#POST switch_lock_admin" do
      ...
      it "locks and unlocks changes succesfully" do
        post :switch_lock_admin if ApplicationHelper.status_lock? # we make sure we start unlocked
      ...
      describe ",when enabled," do
        ...
        before(:each) do
          sign_out user
          sign_in user_admin
          post :switch_lock_admin unless ApplicationHelper.status_lock? # we make sure we start locked
          sign_out user_admin
